...
extension BioPatience {
    static func mocData(waited: Bool = false) -> BioPatience {
        return BioPatience(id: UUID().uuidString, startDate: Date(), stopDate: Date.tomorrow, date: Date.tomorrow, text: "test text", waited: waited)
    }
}
